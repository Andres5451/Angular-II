...
@Component({
  ...
  imports: [CardModule, ButtonModule, InputTextModule, FormsModule, FloatLabel, TableModule],
...
///Lista de articulos 
  ...
  save(){
    ...
    this.listado.update((histortial: any[]) => {
      const item = {
        precio: this.precio(),
        IVAEnPorcentaje: this.IVAEnPorcentaje(),
        iva: this.IVAEnPorcentaje(),
        total: this.total()
      }
      return [...histortial, item];
    });
  }
